...
# Load
table_img_id_list, table_coord_list, table_img_arr = table_image_retriever.load_whole_images_and_bbox()
chair_img_id_list, chair_coord_list, chair_img_arr = chair_image_retriever.load_whole_images_and_bbox()
sculpture_img_id_list, sculpture_coord_list, sculpture_img_arr = sculpture_image_retriever.load_whole_images_and_bbox()
laptop_img_id_list, laptop_coord_list, laptop_img_arr = laptop_image_retriever.load_whole_images_and_bbox()
desk_img_id_list, desk_coord_list, desk_img_arr = desk_image_retriever.load_whole_images_and_bbox()
houseplant_img_id_list, houseplant_coord_list, houseplant_img_arr = houseplant_image_retriever.load_whole_images_and_bbox()
shelf_img_id_list, shelf_coord_list, shelf_img_arr = shelf_image_retriever.load_whole_images_and_bbox()
couch_img_id_list, couch_coord_list, couch_img_arr = couch_image_retriever.load_whole_images_and_bbox()
stairs_img_id_list, stairs_coord_list, stairs_img_arr = stairs_image_retriever.load_whole_images_and_bbox()
vase_img_id_list, vase_coord_list, vase_img_arr = vase_image_retriever.load_whole_images_and_bbox()
bench_img_id_list, bench_coord_list, bench_img_arr = bench_image_retriever.load_whole_images_and_bbox()
computer_monitor_img_id_list, computer_monitor_coord_list, computer_monitor_img_arr = computer_monitor_image_retriever.load_whole_images_and_bbox()
computer_keyboard_img_id_list, computer_keyboard_coord_list, computer_keyboard_img_arr = computer_keyboard_image_retriever.load_whole_images_and_bbox()
sink_img_id_list, sink_coord_list, sink_img_arr = sink_image_retriever.load_whole_images_and_bbox()
bed_img_id_list, bed_coord_list, bed_img_arr = bed_image_retriever.load_whole_images_and_bbox()
cabinetry_img_id_list, cabinetry_coord_list, cabinetry_img_arr = cabinetry_image_retriever.load_whole_images_and_bbox()
television_img_id_list, television_coord_list, television_img_arr = television_image_retriever.load_whole_images_and_bbox()
curtain_img_id_list, curtain_coord_list, curtain_img_arr = curtain_image_retriever.load_whole_images_and_bbox()
piano_img_id_list, piano_coord_list, piano_img_arr = piano_image_retriever.load_whole_images_and_bbox()
mirror_img_id_list, mirror_coord_list, mirror_img_arr = mirror_image_retriever.load_whole_images_and_bbox()
countertop_img_id_list, countertop_coord_list, countertop_img_arr = countertop_image_retriever.load_whole_images_and_bbox()
drawer_img_id_list, drawer_coord_list, drawer_img_arr = drawer_image_retriever.load_whole_images_and_bbox()
lamp_img_id_list, lamp_coord_list, lamp_img_arr = lamp_image_retriever.load_whole_images_and_bbox()
fireplace_img_id_list, fireplace_coord_list, fireplace_img_arr = fireplace_image_retriever.load_whole_images_and_bbox()
chest_of_drawers_img_id_list, chest_of_drawers_coord_list, chest_of_drawers_img_arr = chest_of_drawers_image_retriever.load_whole_images_and_bbox()
