# -*- coding: utf-8 -*-
"""
Created on Sat Dec 12 11:10:18 2020

@author: user
"""

### Configuration - Packages and Imports
###############################################################################
...
### Configuration - Data Processing and Model Parameters
###############################################################################
...
class_mapping = None
model_path = 'C:/keras_model_save/couch_tv_coffee_table_detector.hdf5'
...
###############################################################################
# Television
tv_image_retriever = imm.OpenCVCroppedImageRetriever(class_name = 'Television', max_images = 100)
tv_img_id_list, tv_coord_list, tv_img_arr = tv_image_retriever.get_whole_images_and_bbox()

# Couch
couch_image_retriever = imm.OpenCVCroppedImageRetriever(class_name = 'Couch', max_images = 100)
couch_img_id_list, couch_coord_list, couch_img_arr = couch_image_retriever.get_whole_images_and_bbox()


# Coffee Table
ct_image_retriever = imm.OpenCVCroppedImageRetriever(class_name = 'Coffee table', max_images = 100)
